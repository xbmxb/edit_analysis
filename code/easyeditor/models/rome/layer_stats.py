...
def layer_stats(
    ...
    def get_ds():
        # Load_From_File
        # from datasets import Dataset
        raw_ds = Dataset.from_file('/data/maxb/mememe/EasyEdit/wiki20200501cache/wikipedia/20200501.en/1.0.0/009f923d9b6dd00c00c8cdc7f408f2b47f45dd4f5fb7982a21f9448f4afbe475/wikipedia-train.arrow')
        # raw_ds = {'train': raw_ds}
        # raw_ds = load_dataset(
        #     ds_name,
        #     dict(wikitext="wikitext-103-raw-v1", wikipedia="20200501.en")[ds_name], beam_runner='DirectRunner'
        # )
        # raw_ds = load_dataset('wikipedia', "20230801.en", beam_runner='DirectRunner')
        # raw_ds = load_dataset("wikipedia", "20220501.en", revision="master")
        # raw_ds = load_dataset("wikipedia", "20200501.en", beam_runner='DirectRunner')
        # raw_ds = load_dataset('wikipedia', "20200501.en", split='train', beam_runner='DirectRunner')
