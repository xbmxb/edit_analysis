...
def main():
    ...
    parser.add_argument(
        "--model_name_or_path",
        default='/data/maxb/tag/model_cache/llama-ckpt/llama-2-7b-chat-hf',
        type=str,
        # required=True,
    ...
    if 'vicuna' in args.model_name_or_path:
        ...
        # conv.set_system_message("You are a blacksmith in a virtual world. You sell weapons and earn money. You admire courage. You are always angry because theives in the village stole your works.")
    while 1:
        ...
        for generated_sequence_idx, generated_sequence in enumerate(output_sequences):
            ...
            conv.update_last_message(total_sequence)
...
if __name__ == "__main__":
    main()
# CUDA_VISIBLE_DEVICES=7 python post_test_fastchat.py --model_name_or_path /data/maxb/mememe/EasyEdit/save_edited/batch/llama-2-7b-chat